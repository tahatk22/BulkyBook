...
namespace BulkyBook.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            //if (!role.RoleExistsAsync(SD.Role_Admin).GetAwaiter().GetResult())
            //{
            ...
            //    role.CreateAsync(new IdentityRole(SD.Role_Individual)).GetAwaiter().GetResult();
            //}
            ReturnUrl = returnUrl;
            ExternalLogins = (await _signInManager.GetExternalAuthenticationSchemesAsync()).ToList();
            Input = new InputModel()
            {
                RoleList = new SelectList(role.Roles.ToList(), "Name", "Name"),
                CompanyList = new SelectList(company.GetMany() , "Id" , "Name")
            };
        }
